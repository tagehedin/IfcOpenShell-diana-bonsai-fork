...
classes = (
    ...
    operator.AllWidgetsOff,
    operator.ChangeLibraryElement,
    operator.ClearMeasurement,
    operator.ClearRecentIFCProjects,
    operator.CreateClippingPlane,
    operator.CreateProject,
    operator.DeleteLastBMeasureWidget,
    operator.DeleteLastDimWidget,
    operator.DeleteLastLaserWidget,
    operator.DeleteLastXYZWidget,
    operator.DeleteLastZWidget,
    ...
    operator.HideQueriedElementIfcClass,
    ...
    operator.ToggleLinkStoreyVisibility,
