...
classes = (
    ...
    operator.ExcludeHiddenFromDrawing,
    ...
    operator.RescanLayerStyles,
    operator.SaveLayerStylesToIfc,
    operator.LoadLayerStylesFromIfc,
    operator.SaveLayerStylesToJSON,
    operator.LoadLayerStylesFromJSON,
    operator.ClearLayerSvgFill,
    ...
    ui.BIM_PT_sheets,
    ui.BIM_PT_drawings,
    ui.BIM_PT_layer_properties,
    ui.BIM_UL_layer_styles,
    ui.BIM_PT_camera,
