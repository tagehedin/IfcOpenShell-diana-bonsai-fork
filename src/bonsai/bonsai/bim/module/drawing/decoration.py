...
class CutDecorator:
    ...
    def __call__(self, context):
        ...
        # frame ever saw camera_moved == True). Set on self too: decorate()
        # reads self.camera_moved rather than taking it as an argument.
        camera_moved = self.camera_moved = self.is_camera_moved()
